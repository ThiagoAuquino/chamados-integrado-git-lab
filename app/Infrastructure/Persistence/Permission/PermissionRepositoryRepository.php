...
use App\Domain\Permission\Repositories\PermissionRepositoryRepositoryInterface;
use App\Models\Permission;
use Illuminate\Support\Collection;

class PermissionRepositoryRepository implements PermissionRepositoryRepositoryInterface
{
